 ...
 *
 * Inputs (env): GITHUB_REF_NAME (the tag, e.g. "v3.0.0"), GITHUB_SHA (commit).
...
const pageStyle = `
  body { font-family: ui-monospace, 'SF Mono', Menlo, monospace; background: #0a0514; color: #eeeef4; margin: 0; padding: 32px 24px 64px; }
  a { color: #f07828; }
  h1 { font-size: 20px; margin: 0 0 4px; }
  .meta { color: #a9a3b5; font-size: 13px; margin-bottom: 24px; }
  .stats { display: flex; gap: 16px; margin-bottom: 24px; flex-wrap: wrap; }
  .stat { background: #170f24; border: 1px solid #2d2438; border-radius: 8px; padding: 10px 16px; font-size: 13px; }
  .stat b { font-size: 18px; display: block; }
  .pass b { color: #2ecc71; } .fail b { color: #e74c3c; } .skip b { color: #f5a623; }
  pre { background: #170f24; border: 1px solid #2d2438; border-radius: 8px; padding: 16px; overflow-x: auto; font-size: 12px; line-height: 1.5; white-space: pre-wrap; word-break: break-word; }
  table { border-collapse: collapse; width: 100%; margin-top: 12px; }
  td, th { text-align: left; padding: 6px 10px; border-bottom: 1px solid #2d2438; font-size: 13px; }
`
...
<body>
  ...
  <div class="meta">@byehsan/logo &middot; one page per tagged release</div>
  <table>
    <tr><th>Version</th></tr>
