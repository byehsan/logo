...
beforeAll(() => {
  const workDir = mkdtempSync(join(tmpdir(), 'byehsan-logo-pack-'))
...
describe('npm pack tarball — real consumer install simulation', () => {
  it('extracted tarball contains dist/, palette.json, and the other files-listed paths', () => {
    ...
    for (const expected of ['dist', 'base.svg', 'signature.svg', 'signature-hand.svg', 'states', 'moods', 'http', 'lockup', 'palette.json', 'states.css', 'package.json']) {
